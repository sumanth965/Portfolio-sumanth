...
const skills = [
    // 1. Languages
    {
        label: 'JavaScript', category: 'Languages', color: '#f7df1e', proficiency: 85,
        years: 3, projects: 10, desc: 'Core ES6+ development, DOM manipulation, asynchronous programming with async/await, closures, and browser game logic.',
        tags: ['ES6+', 'Async/Await', 'DOM', 'Event Handling'],
        icon: (
    ...
    {
        label: 'Python', category: 'Languages', color: '#ffd43b', proficiency: 80,
        years: 2, projects: 4, desc: 'Building practical AI, computer-vision and data-processing applications using Python.',
        tags: ['Scripting', 'OpenCV', 'NumPy', 'Data Pipelines'],
        icon: (
    ...
    {
        label: 'Java', category: 'Languages', color: '#f58219', proficiency: 80,
        years: 2, projects: 3, desc: 'Object-oriented Java development with Servlets, JSP, JDBC, MVC architecture and database-driven applications.',
        tags: ['OOP', 'Servlets', 'JSP', 'JDBC'],
        icon: (
    ...
    {
        label: 'C', category: 'Languages', color: '#a8b9cc', proficiency: 70,
        years: 2, projects: 2, desc: 'Fundamental C programming: pointers, memory concepts, structured types, and procedural logic.',
        tags: ['Pointers', 'Memory', 'Structures', 'Procedural'],
        icon: (
            <span style={{ fontFamily: 'monospace', fontWeight: 900, fontSize: '1.2rem', color: '#a8b9cc' }}>C</span>
        ),
    },
    {
        label: 'SQL', category: 'Languages', color: '#e38c00', proficiency: 80,
        years: 2, projects: 4, desc: 'Writing relational database queries, table joins, data filtering, aggregations, and schema modifications.',
        tags: ['Queries', 'JOINs', 'Aggregations', 'DDL/DML'],
        icon: (
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#e38c00" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 6h16M4 12h16M4 18h11"/></svg>
        ),
    },
    {
        label: 'TypeScript', category: 'Languages', color: '#3178c6', proficiency: 70,
        years: 1, projects: 2, desc: 'Adding static type safety, interfaces, typed props, and compile-time error prevention to JS projects.',
        tags: ['Type Safety', 'Interfaces', 'Generics', 'Typed Props'],
        icon: (
    ...
    // 2. Frontend
    {
        label: 'React.js', category: 'Frontend', color: '#61dafb', proficiency: 85,
        years: 2, projects: 8, desc: 'Building responsive and interactive interfaces, dashboards, reusable components and full-stack applications with React.',
        tags: ['Hooks', 'REST APIs', 'Responsive UI', 'State Mgmt'],
        icon: (
    ...
    {
        label: 'HTML5/CSS3', category: 'Frontend', color: '#e34f26', proficiency: 85,
        years: 3, projects: 10, desc: 'Semantic web structure, modern CSS Flexbox/Grid layouts, glassmorphism UI styling, and responsive web design.',
        tags: ['Flexbox/Grid', 'Semantic HTML', 'Glassmorphism', 'CSS3'],
        icon: (
            <svg width="32" height="32" viewBox="0 0 128 128"><path fill="#e34f26" d="M19.34 113.84L8.74 3.68h110.52l-10.6 110.12L63.82 124.32z"/><path fill="#ef652a" d="M64 115.82l36.56-10.14 8.98-93.36H64z"/><path fill="#fff" d="M64 53.64H45.24l-1.32-14.8H64V25.26H26.32l.4 4.56 3.44 38.64H64zm0 37.04l-.16.04-15.48-4.16-1-11.16H33.84l1.96 22 28.16 7.84.04.04z"/><path fill="#ebebeb" d="M64 53.64v13.58h17.44l-1.64 18.34-15.8 4.26V103.4l28.16-7.8.36-4.04 3.28-37.92.4-4.56zM64 25.26v13.58h36.08l1.2-13.58z"/></svg>
        ),
    },

    // 3. Backend
    {
        label: 'Node.js', category: 'Backend', color: '#83cd29', proficiency: 80,
        years: 2, projects: 7, desc: 'Building backend services, RESTful APIs, asynchronous workflows, and request handling with Node.js.',
        tags: ['Runtime', 'Async I/O', 'REST APIs', 'npm Services'],
        icon: (
    ...
    {
        label: 'Express.js', category: 'Backend', color: '#e2e8f0', proficiency: 80,
        years: 2, projects: 7, desc: 'Routing, custom middleware, session management, and authentication integration for web applications.',
        tags: ['Routing', 'Middleware', 'JWT Auth', 'REST Routes'],
        icon: (
            <svg width="34" height="22" viewBox="0 0 128 82"><path fill="#e2e8f0" d="M126.67 98.44c-4.56 1.16-7.38.05-9.91-3.75-5.68-8.51-11.95-16.63-18-24.9-.78-1.07-1.59-2.12-2.6-3.45-6.23 8.51-12.34 16.63-18.33 24.85-2.61 3.58-5.23 5-9.73 3.57l26.38-35.81L69.67 33.32c4.43-1.05 7.21-.38 9.87 3.5 5.77 8.23 12 16.1 18.38 24.05L116.25 33c4.55-1.13 7.36-.4 9.8 3.6L100.67 68.79zM1.33 61.74c.72-3.51 1.28-7.08 2.19-10.54C9.56 32.55 27.37 22.01 47.3 26.72c15.05 3.51 24.39 16.94 24.1 34.02H9.38c-.15 16.99 11.11 27.2 28 24.89 6.52-.9 11.85-4.08 15.23-10.06 1.71-3.01 3.97-4.38 7.43-3.71-1.06 5.92-4.48 10.24-8.94 13.68-10.43 8.01-26.84 8.15-37.56.6C6.53 80.24 2.81 71.74 1.48 62.54c-.06-.45-.24-.88-.36-1.32zm8.23-5.11h46.88c-.33-13.34-9.01-22.67-22-22.47-13.81.2-24.01 9.78-24.88 22.47z" /></svg>
        ),
    },
    {
        label: 'MERN Stack', category: 'Backend', color: '#a855f7', proficiency: 85,
        years: 2, projects: 7, desc: 'Full-stack application development combining MongoDB, Express, React, and Node.js with end-to-end data flows.',
        tags: ['Full-Stack', 'JWT Auth', 'REST APIs', 'CRUD'],
        icon: (
    ...
    {
        label: 'REST API Development', category: 'Backend', color: '#009688', proficiency: 80,
        years: 2, projects: 7, desc: 'Designing and building structured RESTful endpoints, handling HTTP status codes, validation, and JSON payloads.',
        tags: ['Endpoints', 'JSON', 'CRUD', 'HTTP Methods'],
        icon: (
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#009688" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="8" rx="2"/><rect x="2" y="14" width="20" height="8" rx="2"/><line x1="6" y1="6" x2="6.01" y2="6"/><line x1="6" y1="18" x2="6.01" y2="18"/></svg>
        ),
    },
    {
        label: 'Java Servlets/JSP', category: 'Backend', color: '#e76f51', proficiency: 80,
        years: 2, projects: 2, desc: 'Developing web applications using Java Servlets, JSP templates, request dispatching, and session handling.',
        tags: ['Servlets', 'JSP', 'Session Mgmt', 'MVC'],
        icon: (
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#e76f51" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z"/></svg>
        ),
    },
    {
        label: 'JDBC', category: 'Backend', color: '#f4a261', proficiency: 80,
        years: 2, projects: 2, desc: 'Connecting Java applications to relational databases, executing SQL queries, PreparedStatements, and ResultSets.',
        tags: ['PreparedStatements', 'DB Connection', 'SQL Queries', 'ResultSets'],
        icon: (
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#f4a261" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"/><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"/></svg>
        ),
    },

    // 4. Databases
    {
        label: 'MongoDB', category: 'Databases', color: '#13aa52', proficiency: 80,
        years: 2, projects: 6, desc: 'Schema design, CRUD operations, data relationships, aggregation and MongoDB integration through Mongoose.',
        tags: ['NoSQL', 'Document Schema', 'CRUD', 'Atlas'],
        icon: (
    ...
    {
        label: 'MySQL', category: 'Databases', color: '#4479a1', proficiency: 80,
        years: 2, projects: 3, desc: 'Relational database management, table structure definitions, SQL queries, foreign keys, and joins.',
        tags: ['Relational DB', 'Joins', 'Foreign Keys', 'Schema'],
        icon: (
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#4479a1" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"/><path d="M21 5v14c0 1.66-4 3-9 3"/><line x1="3" y1="12" x2="21" y2="12"/></svg>
        ),
    },

    // 5. AI & Computer Vision
    {
        label: 'MediaPipe', category: 'AI & Computer Vision', color: '#ff4081', proficiency: 80,
        years: 1, projects: 2, desc: 'Utilizing Google MediaPipe solutions for hand landmark detection, finger joint tracking, and gesture coordinates.',
        tags: ['Hand Landmarks', 'Joint Tracking', 'Gesture Analysis', 'Vision Pipeline'],
        icon: (
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#ff4081" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 11V6a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v0"/><path d="M14 10V4a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v6"/><path d="M10 10.5V6a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v8"/><path d="M18 8a2 2 0 0 1 2 2v4a6 6 0 0 1-6 6h-2a6 6 0 0 1-6-6v-1.5"/></svg>
        ),
    },
    {
        label: 'OpenCV', category: 'AI & Computer Vision', color: '#5c3ee8', proficiency: 75,
        years: 1, projects: 2, desc: 'Image preprocessing, video frame extraction, color space conversions, drawing annotations, and bounding overlays.',
        tags: ['Image Processing', 'Frame Capture', 'Drawing Shapes', 'Filters'],
        icon: (
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#5c3ee8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="6" r="4"/><circle cx="6" cy="17" r="4"/><circle cx="18" cy="17" r="4"/></svg>
        ),
    },
    {
        label: 'Machine Learning', category: 'AI & Computer Vision', color: '#10b981', proficiency: 70,
        years: 1, projects: 2, desc: 'Understanding basic ML workflows, feature extraction from landmark points, classification logic, and evaluation.',
        tags: ['Feature Extraction', 'Classification', 'Model Evaluation', 'Python'],
        icon: (
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a10 10 0 1 0 10 10H12V2z"/><path d="M12 12L2.1 12a10 10 0 0 1 9.9-10v10z"/></svg>
        ),
    },

    // 6. Development & Tools
    {
        label: 'Git/GitHub', category: 'Development & Tools', color: '#f05032', proficiency: 80,
        years: 3, projects: 10, desc: 'Version control: commit history tracking, branch management, GitHub repository hosting, and project collaboration.',
        tags: ['Git CLI', 'Branching', 'GitHub Flow', 'Version Control'],
        icon: (
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#f05032" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="6" y1="3" x2="6" y2="15"/><circle cx="18" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M18 9a9 9 0 0 1-9 9"/></svg>
        ),
    },
]
